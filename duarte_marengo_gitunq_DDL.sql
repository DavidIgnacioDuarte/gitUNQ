...
('African__Whiz' , 'African__Whiz@gmail.com' , '2016-02-05' , 'Bernal' , 'Esteban Di Lorenzo' , '$>gw*1~fY?jAdJ~P7w' , 101),
('Cuccittini' , 'Cuccittini@yahoo.com.ar' , '2017-05-07' , 'Bernal' , 'Andres Cuccittini' , 'Po>Hs*ktaJn+{fE>CS' , 261),
...
('graffiti5sandra.' , 'graffiti5sandra.@gmail.com' , '2016-03-22' , 'Bosques' , 'Gian Luca Vinci' , 'hcNqNzAzi' , 370),
('maria_lorena' , 'maria_lorena@hotmail.com' , '2016-06-21' , 'Bosques' , 'Maria Lorena Gabo' , 'WCAiQ%/ta' , 158),
('Titta' , 'Titta@gmail.com' , '2017-01-24' , 'Longchamps' , 'Camila Lopez' , 'HqNTzYURj' , 20),
('Rh0de_s1a' , 'Rh0de_s1a@aol.com' , '2019-09-09' , 'Berazategui' , 'Giorgina Campo' , '0bz8k2qze' , 496),
('la__one' ,'la__one@aol.com' , '2016-03-22' , 'Berazategui' , 'Moria Casan' , 'efxp7x6ss' , 336);
...
VALUES
('manageiq' , 'wanakin' , '#include <stdio.h>int main() {printf("Hello World");return 0;}'),
('cloud-custod' , 'acid_burn' , '#include <iostream>int main() { std::cout << "Hello World"; return 0;}'),
('Duelo-de-ley' , 'M1lanes4' , 'IDENTIFICATION DIVISION.PROGRAM-ID. Hello-world.PROCEDURE DIVISION.  DISPLAY "Hello World".  .'),
('checkov' , 'CerealKiller' , 'object HelloWorld extends App {  printIn("Hello World")}'),
('solana' , 'QuEnDi' , 'disp(''Hello World'')'),
('git-cheat-sh' , 'eliotmiranda' , 'namespace HelloWorld{  class Hello {        static void Main(string[] args)   {      System.Console.WriteLine("Hello World");    }  }}'),
('devops-exerc' , 'the_plague5' , 'console.lof ''Hello World'''),
('BaGet' , 'NicoV' , 'program HelloWorld;begin WriteLn(''Hello World'');end.'),
('lbry-sdk' , 'Carlin__C' , 'main(){ print(''Hello World'');}'),
('gardener' , 'anaM0nk' , 'module Main where main :: IO () main = putStrLn "Hello World"'),
('Awesome-pyth' , 'Liereyy' , 'program Hello;begin writeln (''Hello, world.'');end.'),
('links' , 'd.phntm_phreak' , 'puts ''Hello World'''),
('HarmonyOS' , 'Rh0de_s1a' , 'print("Hello World")'),
('Powershell' , 'HAL9000' , 'Write-Output "test output"'),
('HelloGithub' , 'j.l3tto' , 'cat(''Hello World'')'),
('cleanCode-do' , 'Jorge_99' , 'println(''Hello World'');'),
('thyphoon' , 'DilanLens.78' , 'fun main(args: Array<String>){ println("Hello World")}'),
('Stargate-Con' , 'miss.pink' , 'stopMonitoring watcher ifNotNil: [self processBrowser terminateProcess: watcher. watcher := nil.]'),
('cyberduck' , 'space.dragon' , '/*package whatever //do not write package name here */import java.io.*;class GFG { public static void main (String[] args) {  System.out.println("Hello World"); }}'),
('SmartStoreNE' , '3v4_Warlock' , 'println(''Hello World");'),
('RenoirSt' , 'MonkeyJunkie' , 'processBrowser ^ Smalltalk tools processBrowser'),
('AcademicCont' , 'capoch' , '(print "Hello World")'),
('gekko' , 'Taylor13' , 'console.log("Hello World");'),
('freqtrade' , 'theViper' , 'BEGIN DISPLAY("Hello World") END.'),
('QiX' , 'anaM0nk' , 'print "Hello World";'),
('weekly' , 'D0n.S4tur25' , 'puts "Hello World"'),
('Sagan' , 'juan.carlos' , 'self nextPut: Character cr'),
('MachineL-boo' , 'la__one' , 'program helloworld  print *, "Hello World" end program helloworld'),
('instagram-sc' , 'acid_burn' , 'echo "Hello World"'),
('examples' , 'j.l3tto' , '<!DOCTYPE html><html><head></head><body><h1>Hello World<h1></body></html>'),
('css-protips' , 'juan' , 'Transcript show: ''Hello world'''),
('vim-galore' , 'zeroCool' , 'cat(''Hello World'')'),
('Willow' , 'd4n11.nube' , '(#(''BBDD_22'' ''solana'' ''lbry-sdk'' ''electrum'') asOrderedCollection collect:[:each| each size > 12 ifTrue:[each first: 12] ifFalse:[each]]) do: [ :repo | Transcript crShow: repo ]'),
('ScoutSuite' , 'wartortle.22' , 'fun main(args: Array<String>){ println("Hello World")}'),
('My-AWS-app' , 'Prixie' , 'echo "Hello World";'),
('datePasers' , 'blake-kid' , '/*package whatever //do not write package name here */import java.io.*;class GFG { public static void main (String[] args) {  System.out.println("Hello World"); }}'),
('Tetris_java' , 'jorgelin-88' , '#include <stdio.h>int main() {printf("Hello World");return 0;}'),
('cloudsploit' , 'Taylor13' , 'IDENTIFICATION DIVISION.PROGRAM-ID. Hello-world.PROCEDURE DIVISION.  DISPLAY "Hola Munro".  .'),
('CogVM' , 'j.l3tto' , 'Transcript show: ''Hola Munro'''),
('SynapseML' , 'wanakin' , '<!DOCTYPE html><html><head></head><body><h1>Hagan el TP<h1></body></html>');
...
-- La tabla REPOSITORIO cuenta con 1 clave foránea, correspondiéndose al usuario que lo creó:
ALTER TABLE REPOSITORIO
ADD CONSTRAINT fk_usuario FOREIGN KEY usuario
REFERENCES usuario(usuario);

-- La tabla ARCHIVO cuenta con 2 claves foráneas, correspondiéndose al nombre del repositorio al que se subió el mismo,
-- y a su usuario propietario, respectivamente:
ALTER TABLE ARCHIVO
...
-- La tabla COMMIT cuenta con 1 clave foránea, correspondiéndose al archivo que se commiteó:
ALTER TABLE "COMMIT"
ADD CONSTRAINT fk_id_archivo FOREIGN KEY id_archivo
REFERENCES archivo(id);

-- La tabla CONTRIBUCIÓN cuenta con 2 claves foráneas, correspondiéndose al "hash" identificador del commit con el que se contribuyó,
